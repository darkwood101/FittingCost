 ...
 public:
  ...
  void bulk_load(const V values[], int num_keys) {
    ...
    data_node_type::build_model(values, num_keys, &root_data_node_model,
                                params_.approximate_model_computation); // iterates over all data
    DataNodeStats stats;
    root_node_->cost_ = data_node_type::compute_expected_cost( // calls build_node_implicit, iterates over all data again
    ...
    bulk_load_node(values, num_keys, root_node_, num_keys, // calls data_node bulk_load, which iterates over all data again
