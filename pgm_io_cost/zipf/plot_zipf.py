...
e32 = np.array([7819, 78149, 781367])
e64 = np.array([7817, 78135, 781296])
e128 = np.array([7816, 78131, 781269])
...
plt.title(r"$x_i \sim \mathrm{{Zipf}} \big( 1, 10^5 \big)$")
...
plt.savefig("zipf.pdf", bbox_inches="tight")
